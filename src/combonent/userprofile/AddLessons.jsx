...
function AddLessons() {
  ...
  useEffect(() => {
    axiosInstance
      .get(`http://localhost:4000/course/instructor/${instID}`)
  ...
  return (
    <div className="  px-5 mt-4 d-flex items-center justify-center">
      <form
      ...
      >
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="col-span-full sm:col-span-6">
                <label htmlFor="Video" className="block m">
                  Choose Video
                </label>
                <div {...getVideoRootProps()} className="mt-2">
        ...
        <div className="mt-5 d-flex align-items-center justify-content-end ">
          <button
            type="button"
            className={`btn ${style.but2} me-2 mb-2`}
            onClick={Reset}
          >
            Cancel
          </button>
